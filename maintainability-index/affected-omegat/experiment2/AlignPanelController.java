...
public class AlignPanelController {
    ...
    private void setInitialState(Component parent) {
        // Set initial state
        updateHighlight();
        updatePanel();
        reloadBeads();
    ...
    private void setFrameLis() {
        frame.markAcceptedItem.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                setStatus(Status.ACCEPTED, panel.table.getSelectedRows());
            }
        });
        ...
        frame.markNeedsReviewItem.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                setStatus(Status.NEEDS_REVIEW, panel.table.getSelectedRows());
            }
        });
        ...
        frame.clearMarkItem.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                setStatus(Status.DEFAULT, panel.table.getSelectedRows());
            }
        });
