...
public class PreferencesWindowController implements FurtherActionListener {
    ...
    private static HideableNode getTeamNode() {
    ...
    private static HideableNode getAcNode() {
    ...
    private static HideableNode getAppearance() {
